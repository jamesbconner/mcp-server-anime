...
and integrates it with the extensibility framework. It provides a complete implementation
of the AnimeDataProvider interface with AniDB-specific functionality.

The provider supports:
    - Anime search with configurable result limits
    - Detailed anime information retrieval
    - Local database integration for offline capabilities
    - Health checking and status monitoring
    - Graceful error handling and recovery
    - Configuration-driven behavior

The implementation wraps the AniDBService to provide a consistent interface
while maintaining all AniDB-specific features and optimizations.
"""
